...
Cobra merupakan library yang dirancang khusus untuk development aplikasi berbasis command line. Library ini dibuat oleh Steve Francia (spf13), sedangkan Kingpin dibuat oleh Alec Thomas.

---

 - [Kingpin](https://github.com/alecthomas/kingpin), by Alec Thomas, MIT license
 - [Cobra](https://github.com/spf13/cobra), by Steve Francia (spf13), MIT license
