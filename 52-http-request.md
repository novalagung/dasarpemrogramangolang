...
Ok, terakhir sebelum memulai testing, jalankan terlebih dahulu aplikasi pada bab sebelumya [A.51. Web Service API (JSON Data)](/51-web-json-api.html) (jika belum). Kemudian start prompt cmd/terminal baru dan jalankan jalankan program yang barusan kita buat pada bab ini.
