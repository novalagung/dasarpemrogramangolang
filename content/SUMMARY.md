...
* B. Pemrograman Web Go Dasar
  ...
  * [B.4. Template: Render HTML](B-template-render-html.md)
  * [B.5. Template: Render Partial HTML](B-template-render-partial-html.md)
  ...
  * [B.13. File Upload: ParseMultipartForm](B-form-upload-file.md)
  * [B.14. HTTP Request JSON Payload](B-ajax-json-payload.md)
  * [B.15. HTTP Response: JSON](B-ajax-json-response.md)
  * [B.16. Multiple File Upload: MultipartReader](B-ajax-multi-upload.md)
  ...
  * [B.23. Handler Testing (net/http/httptest)](B-httptest-handler-testing.md)
  ...
  * [B.30. HTTP Request Cancellation](B-server-handler-http-request-cancellation.md)
